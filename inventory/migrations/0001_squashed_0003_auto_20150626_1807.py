...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("inventory", "0003_auto_20150626_1807"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    models.ForeignKey(
                        to="inventory.Category", on_delete=models.CASCADE
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=32,
                        verbose_name="UVa equipment number",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        null=True,
                        verbose_name="Warranty or Item expiration (y)",
                        decimal_places=2,
                        max_digits=4,
                    ),
                ),
                ...
                (
                    "order",
                    models.ForeignKey(to="inventory.Order", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="inventory.Item", through="inventory.OrderItem"
            ),
        ),
        migrations.AddField(
            model_name="order",
        ...
        migrations.AddField(
            ...
            name="ptao",
            field=models.ForeignKey(
                blank=True, to="inventory.PTAO", null=True, on_delete=models.SET_NULL
            ),
        ),
        migrations.AddField(
            model_name="item",
