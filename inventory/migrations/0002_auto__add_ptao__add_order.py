...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PTAO'
        db.create_table(u'inventory_ptao', (
        ...
        db.send_create_signal(u'inventory', ['PTAO'])

        # Adding model 'Order'
        db.create_table(u'inventory_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ptao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.PTAO'], null=True, blank=True)),
            ('ordered', self.gf('django.db.models.fields.BooleanField')()),
            ('order_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('ordered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reconciled', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'inventory', ['Order'])

        # Adding M2M table for field items on 'Order'
        m2m_table_name = db.shorten_name(u'inventory_order_items')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'inventory.order'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'PTAO'
        db.delete_table(u'inventory_ptao')

        # Deleting model 'Order'
        db.delete_table(u'inventory_order')

        # Removing M2M table for field items on 'Order'
        db.delete_table(db.shorten_name(u'inventory_order_items'))
