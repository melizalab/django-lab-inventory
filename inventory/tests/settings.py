...
MIDDLEWARE = [
    ...
    "inventory.middleware.LoginAttemptMiddleware",
...
# Minimal static files and host config for dev server
STATIC_URL = "/static/"
ALLOWED_HOSTS = ["*"]
...
LOGIN_REDIRECT_URL = '/university-laboratory-system/'
...
AUTHENTICATION_BACKENDS = [
    'inventory.auth_backends.SecureAuthBackend',
]
